...
export const INITIAL_ADS: AdLink[] = [
  { id: '1', title: 'Adsterra Basic', url: 'https://www.effectivegatecpm.com/gs6yds3bbj?key=2bdbd4e60f386f9699b578e3391223d6', coinReward: 3, billReward: 1, requiredCoins: 0, icon: '🔗', description: 'Nivel Inicial' },
  { id: '2', title: 'Fast Click', url: 'https://www.effectivegatecpm.com/k4czsurww?key=0e37ae6e92b9ff506392a8a06aa4ad5b', coinReward: 6, billReward: 2, requiredCoins: 300, icon: '⚡', description: 'Nivel 2' },
  { id: '3', title: 'Eco Saver', url: 'https://www.effectivegatecpm.com/k4czsurww?key=0e37ae6e92b9ff506392a8a06aa4ad5b', coinReward: 15, billReward: 3, requiredCoins: 1500, icon: '🌿', description: 'Nivel 3' },
  { id: '4', title: 'Bronze Ad', url: 'https://www.effectivegatecpm.com/g8q9e9mih?key=43d7abdb7a1c937c3f8d2ce22859ce55', coinReward: 35, billReward: 5, requiredCoins: 6000, icon: '🥉', description: 'Nivel 4' },
  { id: '5', title: 'Silver Tier', url: 'https://www.effectivegatecpm.com/icbr4z5psh?key=29abbd98b0a63e81679ad4fc320ffb52', coinReward: 80, billReward: 8, requiredCoins: 20000, icon: '🥈', description: 'Nivel 5' },
  { id: '6', title: 'Gold Partner', url: 'https://www.effectivegatecpm.com/g8q9e9mih?key=43d7abdb7a1c937c3f8d2ce22859ce55', coinReward: 200, billReward: 12, requiredCoins: 50000, icon: '🥇', description: 'Nivel 6' },
  { id: '7', title: 'Diamond Ad', url: 'https://www.effectivegatecpm.com/icbr4z5psh?key=29abbd98b0a63e81679ad4fc320ffb52', coinReward: 500, billReward: 18, requiredCoins: 120000, icon: '💎', description: 'Nivel 7' },
  { id: '8', title: 'Legendary Rev', url: 'https://www.effectivegatecpm.com/gs6yds3bbj?key=2bdbd4e60f386f9699b578e3391223d6', coinReward: 1200, billReward: 25, requiredCoins: 300000, icon: '🏆', description: 'Nivel Máximo' },
